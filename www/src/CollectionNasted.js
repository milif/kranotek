(function(){
    ...
    App.defineCollection('CollectionNasted', {
        init: function(){
            this._byPath = {};
            this._fetchedNodes={};
            this._children={};
        ...
        add: function(models){
            var path,
                parentPath,
                model
                resp = App.getCollection('CollectionNasted').__super__.add.apply(this, arguments);
        ...
        remove: function(models){
            ...
            return App.getCollection('CollectionNasted').__super__.remove.apply(this, arguments);
        }       
    });
