App.defineView('NastedList', {
    ...
    tpl: _.template('<div class="container-fluid b-nastedlist">' +
              '<div class="row-fluid b-nastedlist-lists _lists{cid}"></div>' +
          '</div>'),
    tplList: _.template('<div class="b-nastedlist-lists-hh _list{cid}"><div class="b-nastedlist-lists-h">' +
                    '<table class="table table-hover _items{cid}"></table>' +
                '</div></div>'),
    tplItem: _.template('<tr class="b-nastedlist-item _item{cid}"><td >{item}</td></tr>'),
    init: function(){
